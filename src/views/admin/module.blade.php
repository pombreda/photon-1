...
{{-- Title --}}
@section('title')
<title><?= \Config::get('app.name', 'Photon') ?> - <?= $module->name ?></title>
@stop
...
<div class="container-fluid" id="module-settings">
    ...
    <?php foreach ($module->getFieldCollection() as $field): ?>
        <?= $field ?>
    <?php endforeach; ?>
                ...
                json_data: {
                    ...
                    ajax: {
                        ...
                        data: function(n) {
                            ...
                            return {
                                <!--                                column_name: "--><?//=$module->fields[0]->column_name?><!--",-->
                                table_name: "<?=\Request::segment(2)?>",
                                name      : "<?=$module->table_name?>",
                                id        : n.attr
                                    ? n.attr("id").replace(n.attr("data-module-name") + '_', '')
                                    : null
                            };
                        }
                    }
    ...
    <script type="text/javascript"
            src="<?= Config::get('photon::photon.package_assets_uri') ?>/js/admin-module.js"></script>
    @stop
