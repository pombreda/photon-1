...
(function(context) {
    context.elements = new Array(
        ...
        if (!$.isEmptyObject(fieldsJson))
            context.editingMode = true;
        ...
        $("#name").keyup(function() {
            if (context.tableNameLocked || context.editingMode)
                return false;
            context.convertToTableName();
        });
        ...
        if (context.lockedColumnNames[fieldId] === false)
            context.convertToColumnName(fieldId);
    },
...
$(document).ready(function() {
    function validateForm() {
        var url = '/admin/settings/validate';
        var data = $("#admin-settings-form").serialize();
